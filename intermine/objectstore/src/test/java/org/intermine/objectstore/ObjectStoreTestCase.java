...
public class ObjectStoreTestCase {
    ...
    */
    ...
    public void testDataTypes() throws Exception {
        ...
        cs.addConstraint(new SimpleConstraint(floatType, ConstraintOp.EQUALS, new QueryValue(Float.valueOf(0.6F))));
        cs.addConstraint(new SimpleConstraint(doubleType, ConstraintOp.EQUALS, new QueryValue(Double.valueOf(0.88D))));
        cs.addConstraint(new SimpleConstraint(shortType, ConstraintOp.EQUALS, new QueryValue(Short.valueOf((short) 675))));
        cs.addConstraint(new SimpleConstraint(intType, ConstraintOp.EQUALS, new QueryValue(Integer.valueOf(267))));
        cs.addConstraint(new SimpleConstraint(longType, ConstraintOp.EQUALS, new QueryValue(Long.valueOf(98729353495843l))));
        cs.addConstraint(new SimpleConstraint(booleanObjType, ConstraintOp.EQUALS, new QueryValue(Boolean.TRUE)));
        cs.addConstraint(new SimpleConstraint(floatObjType, ConstraintOp.EQUALS, new QueryValue(Float.valueOf(1.6F))));
        cs.addConstraint(new SimpleConstraint(doubleObjType, ConstraintOp.EQUALS, new QueryValue(Double.valueOf(1.88D))));
        cs.addConstraint(new SimpleConstraint(shortObjType, ConstraintOp.EQUALS, new QueryValue(Short.valueOf((short) 1982))));
        cs.addConstraint(new SimpleConstraint(intObjType, ConstraintOp.EQUALS, new QueryValue(Integer.valueOf(369))));
        cs.addConstraint(new SimpleConstraint(longObjType, ConstraintOp.EQUALS, new QueryValue(Long.valueOf(38762874323212l))));
